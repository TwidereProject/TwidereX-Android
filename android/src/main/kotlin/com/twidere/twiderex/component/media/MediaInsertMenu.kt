...
private fun MediaInsertType.stringName() = when (this) {
    MediaInsertType.CAMERA -> stringResource(id = com.twidere.common.R.string.accessibility_scene_compose_media_insert_camera)
    MediaInsertType.RECORD_VIDEO -> stringResource(id = com.twidere.common.R.string.accessibility_scene_compose_media_insert_record_video)
    MediaInsertType.LIBRARY -> stringResource(id = com.twidere.common.R.string.accessibility_scene_compose_media_insert_library)
    MediaInsertType.GIF -> stringResource(id = com.twidere.common.R.string.accessibility_scene_compose_media_insert_gif)
}
