...
class NitterTest {
  ...
  fun userTest() = runBlocking {
    val file = File("src/commonTest/resources/api/nitter/sample_user.html").readText()
  ...
  fun conversationTest(): Unit = runBlocking {
    val file = File("src/commonTest/resources/api/nitter/sample_conversation.html").readText()
